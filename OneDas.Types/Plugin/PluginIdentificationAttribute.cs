...
namespace OneDas.Plugin
{
    ...
    public class PluginIdentificationAttribute : Attribute
    {
        public PluginIdentificationAttribute(string id, string name, string description, string relativeViewPath, string ViewModelResourceName)
        {
            this.Id = id;
            this.Name = name;
